...
CREATE SEQUENCE SEQ_AUTH_KEY_CODE NOCACHE; -- 시퀀스 인증키

ALTER TABLE "AUTH_KEY" DROP COLUMN "MEMBER_NO";
...
COMMENT ON COLUMN "REPORT"."TARGET_TYPE" IS '신고 작성 글 타입';
COMMENT ON COLUMN "REPORT"."TARGET_NO" IS '신고 작성 글 번호';
