...
| 이름 | 담당 기능 | GitHub |
|------|-----------|--------|
| **박상민** | 취미 탐색, 게시글 상세 페이지(좋아요·조회수), 신고 모달, 신고 누적 제재, 신고/제재/문의 관리 페이지, 로그인 및 관리자 필터, 이미지 스케줄링 | [naughtyhoo17-rgb](https://github.com/naughtyhoo17-rgb) |
| **박유진** | 메인화면, 회원 탈퇴, 프로필 변경, 헤더, 풋터 | [PYJ0915](https://github.com/PYJ0915) |
| **박세현** | 로그인, 로그아웃, 회원가입, 아이디 찾기, 비밀번호 찾기 | [sehyeon1689](https://github.com/sehyeon1689) |
| **양충모** | 게시판 화면 구현(공지·취미·자유), 게시판 기능(페이지 이동·검색·내 글·랭킹), 게시글 작성(SummerNote), 게시글 수정/삭제 | [ycm93277211-ai](https://github.com/ycm93277211-ai) |
| **전주영** | 마이페이지(회원 정보 조회·수정·비밀번호 변경), 게시판 댓글(조회·작성·수정·삭제·신고·대댓글) | [juyoung-97](https://github.com/juyoung-97) |
