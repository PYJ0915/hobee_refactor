...
public class ChallengeController {
    ...
    public String challengeDetail(
        ...
        if (loginMember != null) {
            List<Cert> myCertList = service.getCertList(challengeNo, memberNo);
    ...
    public Map<String, Object> certify(
            @PathVariable("challengeNo") int challengeNo,
            @RequestParam("certTitle")   String certTitle,
    ...
    @ResponseBody
    @GetMapping("my")
    public List<Challenge> myChallenges(
            @SessionAttribute("loginMember") MemberDTO loginMember) {
    ...
    public List<Cert> getCertList(
            @RequestParam("challengeNo") int challengeNo, @RequestParam("memberNo") int memberNo) {
