...
INSERT INTO "MEMBER"
VALUES(2, 'test1', '$2a$10$nfGb86TM/w47uc3ZAQZ0jef5ZD2OvBx/3/8zkgJLnwecrtZHz2ucu', '전주영', 'boduni20@gmail.com', '테스트관리자', '01021868825', '서울시노원구중계로8길39', DEFAULT, 2, 'N');
...
ALTER TABLE "BOARD" ADD "CATEGORY_CODE" NUMBER;

-- 컬럼에 대한 설명 추가
COMMENT ON COLUMN "BOARD"."CATEGORY_CODE" IS '게시판 카테고리 번호 (FK)';
...
--PROFILE_IMG 테이블 관련 수행 코드--

--프로필 번호 시퀀스 
CREATE SEQUENCE SEQ_PROFILE_NO NOCACHE;

ALTER TABLE "PROFILE_IMG" ADD CONSTRAINT "PK_PROFILE_FILE" PRIMARY KEY(
"PROFILE_NO"
);
--FK 제약 조건 
...
CREATE SEQUENCE SEQ_BOARD_IMG NOCACHE;
